<div class="container">
    <h1>Hey, i'm Dani! 🏳️‍⚧️</h1>
    <div class="separator"></div>
    <p>If you're here, you probably know me from discord, but if you don't, let me introduce myself!</p>
    <div class="separator"></div>
    <p>My name is Daniella (Dani for short) and i'm a 13 year old trans girl from the UK (yes I do in fact hate it here)<br/>
    ...
    <a class="special-button" href="/pronouns">pronouns</a>
    <div class="separator"></div>
